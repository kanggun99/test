...
<head>
    ...
    <style>
        ...
        /*로딩 이미지*/
        .wrap-loading div {position: fixed; top: 50%; left: 50%; margin-left: -40px; margin-top: -80px;}
        .login_info_btn_area button i {font-size: 16px; vertical-align: middle; line-height: 16px;}
        .login_info_btn_area button span {vertical-align: middle; line-height: 16px;}
        .top-storeName {float: left; height: 36px; overflow: hidden; margin: 13px 50px 0 0; font-size: 20px; font-weight: bold; color: #d7d7d7; padding-left: 56px;}
    </style>
